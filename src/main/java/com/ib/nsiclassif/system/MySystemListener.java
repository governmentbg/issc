...
//		}
		...
		/*
		 * try { LOGGER.debug("Trying to SHUTDOWN JPA ...");
		 * 
		 * JPA.shutdown(); } catch (Exception e) {
...
//				SystemDataSynchronizer synchronizer = new DocuSystemDataSynchronizer(systemData, Long.parseLong(setting) * 60);
//
//				ServletContext servletContext = (ServletContext) FacesContext.getCurrentInstance().getExternalContext().getContext();
